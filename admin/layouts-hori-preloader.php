                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div>
                                                        ...
                                                        <a href="ui-roundslider.php" class="dropdown-item">Round slider</a>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                                    <a href="advance-rangeslider.php" class="dropdown-item">Range Slider</a>
                                                    <a href="advance-roundslider.php" class="dropdown-item">Round Slider</a>
                                                    <a href="advance-session-timeout.php" class="dropdown-item">Session Timeout</a>
                                                    <a href="advance-sweet-alert.php" class="dropdown-item">Sweetalert 2</a>
                                                    <a href="advance-rating.php" class="dropdown-item">Rating</a>
                                                    <a href="advance-notification.php" class="dropdown-item">Notification</a>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-form"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                                    ...
                                                    <a href="icons-fontawesome.php" class="dropdown-item">Font awesome 5</a>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-layout-verti">
                                                    <a href="layouts-dark-sidebar.php" class="dropdown-item" key="t-dark-sidebar">Dark Sidebar</a>
